...
function rstr2hex(input) {
    ...
    var output = "";
    var x;
    for (var i = 0; i < input.length; i++) {var getParam = (function () {
...
function decodeData(data) {
    data1 = AES.decrypt(data, aes_server_key, aes_server_iv);
    data2 = DES.decrypt(data1, des_key, des_iv);
    data3 = BASE64.decrypt(data2);
...
function getAQIData(e) {
    ...
    // var param = {city: "北京", type: "HOUR", startTime: "2019-05-27 13:00:00", endTime: "2019-05-28 16:00:00"};
    var q = getServerData(method, e, function (obj) {
        data = obj.data;
        if (data.total > 0) {
